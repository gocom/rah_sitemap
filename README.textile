...
p. Rah_sitemap supports modules. The plugin's own modules can be used to add new functionality. Please see "extending":https://github.com/gocom/rah_sitemap/tree/master/extending directory on GitHub for more about modules and to download some existing ones.
